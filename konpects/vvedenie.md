Конспект по предмету вычислительные системы, сети, телекоммуникации. 
...
1. Компьютеры, соответствующие назначению компьютерной сети;

2. Коммуникационное оборудование;

3. Сетевые операционные системы (NOS – Network Operation
System);
