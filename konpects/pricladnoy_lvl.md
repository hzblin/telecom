...
1. веб-сервер и браузер, сервер TELNET и TELNET-клиент.
2. Клиентская и серверная стороны взаимодействуют обмениваясь сообщениями.
- Peer-to-peer.
...
## DomainName Class Type Value
    ...
    Type – тип записи (A – IP-адрес хоста, NS – информация о сервере имен верхнего уровня, CNAME – псевдоним, МX – запись почтового сервера и др.);
